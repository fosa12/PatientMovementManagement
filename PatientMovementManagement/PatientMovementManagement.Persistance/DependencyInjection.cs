...
namespace PatientMovementManagement.Persistance
{
    public static class DependencyInjection
    {
        ...
        {
            services.AddDbContext<PatientMovementDbContext>(options => options.UseSqlServer(configuration.GetConnectionString("PatientMovementManager")));
            services.AddScoped<IPatientMoveDbContext, PatientMovementDbContext>();
