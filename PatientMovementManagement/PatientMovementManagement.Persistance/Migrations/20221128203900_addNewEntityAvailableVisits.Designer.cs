...
namespace PatientMovementManagement.Persistance.Migrations
{
    ...
    [Migration("20221128203900_addNewEntityAvailableVisits")]
    partial class addNewEntityAvailableVisits
    {
            ...
            modelBuilder.Entity("PatientMovementManagement.Domain.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 11, 28, 21, 39, 0, 171, DateTimeKind.Local).AddTicks(2521),
                            CreatedBy = "SYSTEM",
                            FirstName = "Jan",
                            LastName = "Kowalski",
                            Position = "Lekarz",
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2022, 11, 28, 21, 39, 0, 171, DateTimeKind.Local).AddTicks(2586),
                            CreatedBy = "SYSTEM",
                            FirstName = "Andrzej",
                            LastName = "Lesno",
                            Position = "Lekarz",
                        ...
                        {
                            Id = 3,
                            Created = new DateTime(2022, 11, 28, 21, 39, 0, 171, DateTimeKind.Local).AddTicks(2597),
                            CreatedBy = "SYSTEM",
                            FirstName = "Edward",
                            LastName = "Abramczuk",
                            Position = "Lekarz",
                        ...
                        {
                            Id = 4,
                            Created = new DateTime(2022, 11, 28, 21, 39, 0, 171, DateTimeKind.Local).AddTicks(2608),
                            CreatedBy = "SYSTEM",
                            FirstName = "Ewa",
                            LastName = "Kowalska",
                            Position = "Lekarz",
                        ...
                        {
                            Id = 5,
                            Created = new DateTime(2022, 11, 28, 21, 39, 0, 171, DateTimeKind.Local).AddTicks(2622),
                            CreatedBy = "SYSTEM",
                            FirstName = "Janina",
                            LastName = "Konieczna",
                            Position = "Lekarz",
            ...
            modelBuilder.Entity("PatientMovementManagement.Domain.Entities.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 11, 28, 21, 39, 0, 171, DateTimeKind.Local).AddTicks(2671),
                            CreatedBy = "SYSTEM",
                            FirstName = "Piotr",
                            LastName = "Konieczny",
                            PESEL = "99050443415",
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2022, 11, 28, 21, 39, 0, 171, DateTimeKind.Local).AddTicks(2685),
                            CreatedBy = "SYSTEM",
                            FirstName = "Andrzej",
                            LastName = "Wajda",
                            PESEL = "48080132121",
                        ...
                        {
                            Id = 3,
                            Created = new DateTime(2022, 11, 28, 21, 39, 0, 171, DateTimeKind.Local).AddTicks(2694),
                            CreatedBy = "SYSTEM",
                            FirstName = "Jan",
                            LastName = "Jagiełło",
                            PESEL = "92030332444",
                        ...
                        {
                            Id = 4,
                            Created = new DateTime(2022, 11, 28, 21, 39, 0, 171, DateTimeKind.Local).AddTicks(2703),
                            CreatedBy = "SYSTEM",
                            FirstName = "Krystyna",
                            LastName = "Kowalska",
                            PESEL = "05241477321",
                        ...
                        {
                            Id = 5,
                            Created = new DateTime(2022, 11, 28, 21, 39, 0, 171, DateTimeKind.Local).AddTicks(2713),
                            CreatedBy = "SYSTEM",
                            FirstName = "Michał",
                            LastName = "Żabiński",
                            PESEL = "04300798759",
