...
namespace PatientMovementManagement.Persistance.Migrations
{
    ...
    [Migration("20221112171511_seedData3")]
            ...
            modelBuilder.Entity("PatientMovementManagement.Domain.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 11, 12, 18, 15, 11, 147, DateTimeKind.Local).AddTicks(6541),
                            CreatedBy = "SYSTEM",
                            FirstName = "Jan",
                            LastName = "Kowalski",
                            Position = "Lekarz",
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2022, 11, 12, 18, 15, 11, 147, DateTimeKind.Local).AddTicks(6607),
                            CreatedBy = "SYSTEM",
                            FirstName = "Andrzej",
                            LastName = "Lesno",
                            Position = "Lekarz",
                        ...
                        {
                            Id = 3,
                            Created = new DateTime(2022, 11, 12, 18, 15, 11, 147, DateTimeKind.Local).AddTicks(6617),
                            CreatedBy = "SYSTEM",
                            FirstName = "Edward",
                            LastName = "Abramczuk",
                            Position = "Lekarz",
                        ...
                        {
                            Id = 4,
                            Created = new DateTime(2022, 11, 12, 18, 15, 11, 147, DateTimeKind.Local).AddTicks(6627),
                            CreatedBy = "SYSTEM",
                            FirstName = "Ewa",
                            LastName = "Kowalska",
                            Position = "Lekarz",
                        ...
                        {
                            Id = 5,
                            Created = new DateTime(2022, 11, 12, 18, 15, 11, 147, DateTimeKind.Local).AddTicks(6636),
                            CreatedBy = "SYSTEM",
                            FirstName = "Janina",
                            LastName = "Konieczna",
                            Position = "Lekarz",
            ...
            modelBuilder.Entity("PatientMovementManagement.Domain.Entities.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 11, 12, 18, 15, 11, 147, DateTimeKind.Local).AddTicks(6651),
                            CreatedBy = "SYSTEM",
                            FirstName = "Piotr",
                            LastName = "Konieczny",
                            PESEL = "99050443415",
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2022, 11, 12, 18, 15, 11, 147, DateTimeKind.Local).AddTicks(6662),
                            CreatedBy = "SYSTEM",
                            FirstName = "Andrzej",
                            LastName = "Wajda",
                            PESEL = "48080132121",
                        ...
                        {
                            Id = 3,
                            Created = new DateTime(2022, 11, 12, 18, 15, 11, 147, DateTimeKind.Local).AddTicks(6694),
                            CreatedBy = "SYSTEM",
                            FirstName = "Jan",
                            LastName = "Jagiełło",
                            PESEL = "92030332444",
                        ...
                        {
                            Id = 4,
                            Created = new DateTime(2022, 11, 12, 18, 15, 11, 147, DateTimeKind.Local).AddTicks(6705),
                            CreatedBy = "SYSTEM",
                            FirstName = "Krystyna",
                            LastName = "Kowalska",
                            PESEL = "05241477321",
                        ...
                        {
                            Id = 5,
                            Created = new DateTime(2022, 11, 12, 18, 15, 11, 147, DateTimeKind.Local).AddTicks(6715),
                            CreatedBy = "SYSTEM",
                            FirstName = "Michał",
                            LastName = "Żabiński",
                            PESEL = "04300798759",
